...
fun! s:set_color_variables()
  ...
  call s:create_color_variables('red',       color09 , 'LightGreen') " import / try/catch
...
fun! s:apply_syntax_highlightings()
  ...
  exec 'hi haskellOperators' . s:fg_pink . s:ft_bold
  exec 'hi haskellWhere' . s:fg_foreground . s:ft_bold
  exec 'hi haskellDelimiter' . s:fg_aqua . s:ft_bold
  exec 'hi haskellImportKeywords' . s:fg_green . s:ft_bold
